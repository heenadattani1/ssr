...
import { authRoutes, DataLayerService, localStorageConstant, LocalStorageService, registrationRoutes, virtualChallengeRoutes, VirtualChallengeSharedDataService } from 'src/app/@core/utils';
import { AuthDataService } from 'src/app/@core/data';
@Component({
