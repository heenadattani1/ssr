...
import { VirtualChallengeDataService } from 'src/app/@core/data';
...
import { authRoutes, LocalStorageService, registrationRoutes, sessionStorageConstant, SessionStorageService, virtualChallengeRoutes } from 'src/app/@core/utils';
