...
import { Races, Sponsor, Sponsors } from '../../interfaces/gql-data.interface';
import { fetchRaceData, fetchRaceList, fetchRaceUpdates, getAllSponsors, SponsorBySlug } from '../../graphql/graphql';
